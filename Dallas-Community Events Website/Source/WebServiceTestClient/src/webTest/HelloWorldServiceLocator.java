...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements webTest.HelloWorldService {
    ...
    private java.lang.String HelloWorld_address = "http://localhost:8080/WebServiceTest/services/HelloWorld";
    ...
    public webTest.HelloWorld getHelloWorld() throws javax.xml.rpc.ServiceException {
    ...
    public webTest.HelloWorld getHelloWorld(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            webTest.HelloWorldSoapBindingStub _stub = new webTest.HelloWorldSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (webTest.HelloWorld.class.isAssignableFrom(serviceEndpointInterface)) {
                webTest.HelloWorldSoapBindingStub _stub = new webTest.HelloWorldSoapBindingStub(new java.net.URL(HelloWorld_address), this);
                _stub.setPortName(getHelloWorldWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://webTest", "HelloWorldService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://webTest", "HelloWorld"));
        }
